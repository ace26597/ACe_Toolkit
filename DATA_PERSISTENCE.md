...
**Protected:** ✅ `.gitignore` includes `*.sqlite`

**Backup Recommended:** ✅ YES - Contains all user data

**Persistence:**
- ✅ Survives reboots
- ✅ Survives app restarts
- ✅ Survives git operations (not tracked)
...
**Protected:** ✅ `.gitignore` includes `logs/`, `*.log`, `*.pid`
...
**Protected:** ✅ `.gitignore` includes `node_modules`, `.venv`

**Persistence:**
- ✅ Survives reboots
- 🔄 Can be regenerated from package.json / requirements.txt
- 💾 Takes up significant disk space (~500MB - 1GB)
...
**Protected:** ✅ `.gitignore` includes `.next`, `__pycache__`

**Persistence:**
- ✅ Survives reboots
- 🔄 Can be regenerated by rebuilding
- 🚀 Speeds up startup (cached builds)
...
**Protected:** ✅ `.gitignore` includes `.cloudflared/`, `*.pem`
...
**Backup:** ✅ YES - Backup securely (encrypted)

**Persistence:**
- ✅ Survives reboots
- ✅ Enables auto-start without re-authentication
- 🔒 Contains secrets (never commit to git)
...
- ✅ Backend FastAPI (crontab → start_all.sh)
- ✅ Frontend Next.js (crontab → start_all.sh)
...
|-----------|----------|-----------------|---------------|-----------------|
| Database | `apps/api/mermaid.sqlite` | ✅ | ✅ | 🔴 Critical |
| Environment | `apps/api/.env` | ✅ | ✅ | 🔴 Critical |
| CF Credentials | `~/.cloudflared/` | ✅ | ✅ | 🔴 Critical |
| Logs | `logs/` | ✅ | ✅ | 🟡 Medium |
| Node Modules | `node_modules/` | ✅ | ✅ | 🟢 Low (regenerable) |
| Venv | `.venv/` | ✅ | ✅ | 🟢 Low (regenerable) |
| Build Cache | `.next/` | ✅ | ✅ | 🟢 Low (regenerable) |
