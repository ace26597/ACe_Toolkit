...
from app.wiki.config import configs, DEFAULT_EXCLUDED_DIRS, DEFAULT_EXCLUDED_FILES
from app.wiki.ollama_patch import OllamaDocumentProcessor
...
def count_tokens(text: str, embedder_type: str = None, is_ollama_embedder: bool = None) -> int:
    ...
    try:
        ...
        if embedder_type is None:
            from app.wiki.config import get_embedder_type
