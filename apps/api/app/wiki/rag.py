...
from app.wiki.tools.embedder import get_embedder
from app.wiki.prompts import RAG_SYSTEM_PROMPT as system_prompt, RAG_TEMPLATE
...
from app.wiki.config import configs
from app.wiki.data_pipeline import DatabaseManager
...
class RAG(adal.Component):
    ...
    def __init__(self, provider="google", model=None, use_s3: bool = False):  # noqa: F841 - use_s3 is kept for compatibility
        ...
        from app.wiki.config import get_embedder_config, get_embedder_type
        ...
        if self.is_ollama_embedder:
            from app.wiki.ollama_patch import check_ollama_model_exists
            from app.wiki.config import get_embedder_config
...
9. For pipe characters (|) in text, write them directly without escaping them"""
        ...
        from app.wiki.config import get_model_config
