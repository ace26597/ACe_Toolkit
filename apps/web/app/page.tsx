    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <header className="border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950">
        <div className="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="text-lg font-semibold text-indigo-600">ACe Toolkit</div>
      ...
      <main className="flex flex-col items-center justify-center p-4 sm:p-8 md:p-12 lg:p-24">
        <div className="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex flex-col">
          ...
          <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 mb-6 sm:mb-8 text-center">
            AI-powered research, data analysis, and video creation platform
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 w-full max-w-2xl">
            ...
            >
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                ...
                <span className="text-[10px] sm:text-xs bg-pink-100 dark:bg-pink-900/30 text-pink-700 dark:text-pink-400 px-2 py-0.5 rounded">📱 Mobile</span>
              </div>
            </Link>
            ...
            >
              ...
              <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-2">
                AI-powered video creation with Claude Code terminal. Describe your idea and watch Claude research, design, and render stunning videos.
              </p>
              <div className="flex flex-wrap gap-2 mt-2">
                <span className="text-[10px] sm:text-xs bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-400 px-2 py-0.5 rounded">Remotion</span>
                <span className="text-[10px] sm:text-xs bg-pink-100 dark:bg-pink-900/30 text-pink-700 dark:text-pink-400 px-2 py-0.5 rounded">Claude Terminal</span>
                <span className="text-[10px] sm:text-xs bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-400 px-2 py-0.5 rounded">Full Skill Access</span>
              </div>
            </Link>
          </div>
