  ...
  return (
    <div className="w-full max-w-2xl mt-8">
      ...
      {loading ? (
        ...
        <div className="bg-white dark:bg-slate-800 rounded-lg border border-gray-200 dark:border-slate-700 divide-y divide-gray-200 dark:divide-slate-700 overflow-hidden">
      ...
      {!loading && sessions.length > 0 && (
        <div className="mt-2 text-center">
          <Link
            ...
            className="text-xs text-slate-500 hover:text-indigo-500 dark:text-slate-400 dark:hover:text-indigo-400 transition-colors"
          >
            View all sessions →
          </Link>
        </div>
