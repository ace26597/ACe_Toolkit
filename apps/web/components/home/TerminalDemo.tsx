...
const demoScript: DemoLine[] = [
  { type: 'input', text: '$ claude "Analyze sales.csv and create a summary report"', delay: 0 },
  ...
  { type: 'thinking', text: '● Analyzing patterns...', delay: 600 },
  ...
  { type: 'thinking', text: '● Generating report...', delay: 500 },
  { type: 'success', text: '✓ Created report.md with executive summary', delay: 400 },
  { type: 'success', text: '✓ Created charts/revenue.png', delay: 300 },
  { type: 'success', text: '✓ Created charts/segments.png', delay: 300 },
  { type: 'info', text: '', delay: 400 },
  { type: 'input', text: '$ claude "Now create a PowerPoint presentation"', delay: 1000 },
  { type: 'thinking', text: '● Loading /pptx skill...', delay: 600 },
  { type: 'output', text: '  Using template: business-modern', delay: 400 },
  { type: 'thinking', text: '● Building slides...', delay: 500 },
  { type: 'output', text: '  Slide 1: Executive Summary', delay: 300 },
  { type: 'output', text: '  Slide 2: Revenue Trends', delay: 250 },
  { type: 'output', text: '  Slide 3: Top Products', delay: 250 },
  { type: 'output', text: '  Slide 4: Customer Segments', delay: 250 },
  { type: 'output', text: '  Slide 5: Recommendations', delay: 250 },
  { type: 'success', text: '✓ Created Sales_Report_2025.pptx (5 slides)', delay: 400 },
  { type: 'info', text: '', delay: 300 },
  { type: 'info', text: '  Total time: 12.3s | Tokens: 2,847', delay: 200 },
];
